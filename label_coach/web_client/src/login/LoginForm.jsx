...
class LoginFormP extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div id="Login" className="col-md-4 offset-md-4">
            <div className="row" id="login_logo">
                <Logo/>
                </div>
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <span>Dont have an account yet? <Link to="/register" className="btn btn-link">Register Here</Link></span>
                    </div>
                </form>
            </div>
